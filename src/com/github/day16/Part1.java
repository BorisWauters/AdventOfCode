...
public class Part1 {
    ...
    private static int handleOperator(String packet) {
        if (packet.charAt(0) == '0')
            return 1 + handlePacketWithId0(packet.substring(1));
        return 1 + handlePacketWithId1(packet.substring(1));
    }

    private static int handlePacketWithId0(String packet) {
    ...
    private static int handlePacketWithId1(String packet) {
