...
public class Part1 {
    ...
    public static void main(String[] args) {
        try (Stream<String> stream = Files.lines(Paths.get("input/day12.txt"))) {
    ...
    private static void solve(String[] lines) {
        ...
        startPath.add(START);
        findPath(startPath, new HashSet<>());

        System.out.println(numberOfPaths);
    }

    private static void findPath(Deque<String> path, Set<String> cavesToAvoid) {
        ...
        for (String cave : adjacencyMap.get(lastCave)) {
            ...
            newPath.add(cave);
            findPath(newPath, new HashSet<>(cavesToAvoid));
        }
    }
